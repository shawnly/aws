...
def save_organization_summary(df, start_date, end_date):
    ...
    with pd.ExcelWriter(filename, engine='xlsxwriter') as writer:
        ...
        # Add total row at the bottom - THIS IS NEW
        total_row = {
            'Service Name': 'TOTAL',
        ...
        # Add some cell formats - ENHANCED FORMATTING BELOW
        currency_format = workbook.add_format({'num_format': '$#,##0.00'})
        total_format = workbook.add_format({  # THIS IS NEW
            'bold': True, 
            'num_format': '$#,##0.00', 
        ...
        # Highlight the total row - THIS IS NEW
