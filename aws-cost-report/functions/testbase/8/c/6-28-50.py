...
def get_chart_directory(account_id, end_date):
    ...
    if account_id == "organization_summary":
        return f"aws_cost_reports/organization_summary/{year}/{month}/charts"
    else:
        return f"aws_cost_reports/{account_id}/{year}/{month}/charts"
...
def main():
    ...
    if account_id:
        ...
        if all_dfs:
            ...
            create_cost_visualization(
                df_consolidated,
                f"AWS Consolidated Cost by Service ({start_date} to {display_end_date})",
                "consolidated",
                start_date,
                end_date,
                is_organization=False
